...
#                /tmp/hiera and puts it in the
#                /tmp/hiera/hiera-#{version}/payload directory. A DMG is
#                created, using hdiutil, based on the contents of the
#                /tmp/hiera/hiera-#{version}/payload directory. The resultant
...
# method:        pack_source
# description:   This method copies the hiera source into a directory
#                structure in /tmp/hiera/hiera-#{version}/root mirroring the
#                structure on the target system for which the package will be
#                installed. Anything installed into /tmp/hiera/root will be
